...
const GrantHunter = () => {
  ...
  // Dynamic FPL Calculation (Local Preview)
  useEffect(() => {
    if (!income || income <= 0) {
      setFplPct(null);
      return;
  ...
  return (
    <div className="min-h-screen bg-[#0d0f0e] text-[#e8ede9] font-sans selection:bg-[#b8f06a] selection:text-black">
      ...
      <header className="border-b border-[#2a2f2b] px-12 py-8 flex items-baseline gap-4">
        <h1 className="text-[#b8f06a] text-3xl font-serif font-black tracking-tight">Grant Hunter</h1>
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="flex flex-col gap-2">
            ...
            <input 
              ...
              className="bg-[#141714] border border-[#2a2f2b] rounded-lg p-3 outline-none focus:border-[#b8f06a] transition-colors"
              value={income}
          ...
          <div className="flex flex-col gap-2">
            ...
            <select 
              className="bg-[#141714] border border-[#2a2f2b] rounded-lg p-3 outline-none focus:border-[#b8f06a] appearance-none cursor-pointer"
              value={state}
        ...
        >
          {loading ? (
            ...
            <>
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>
              Hunt for Grants
            </>
          )}
        </button>
        ...
        <div className="mt-16 space-y-6">
          {grants.length > 0 && (
            <div className="flex items-center justify-between mb-8">
              ...
              <span className="font-mono text-[10px] text-[#6b756c]">{grants.length} results found</span>
            </div>
          )}
